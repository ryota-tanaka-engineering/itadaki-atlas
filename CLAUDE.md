...
**確定デザイン・確定情報構造で全ページ型実装済み・未デプロイ。** データ投入だけでサイトが伸びる。投入済み: 棚28・ジャンル6（ラーメン61/焼き鳥14/寿司7/和牛10/うどん13/そば13）+ その他35件 = 154件・47都道府県（2026-09 海鮮丼の本場=金沢で石川が埋まり空白県ゼロ）・タグ26語彙/付与94件・チェーン11（ラーメン）。
