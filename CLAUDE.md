...
2026-09 追加: 本場（土地との結びつき第3種別）とチェーン橋渡しを実装（正典は `ia-atlas-content` Skill §2.4・§3、スキーマは `.doc/20_data/01_models.md` §3.6/§3.9）。**未決: 本場を地図ピンに出すか**（現状トップ地図・MapViewは発祥ピンのみ。石川へは「地域から探す」経由）。
...
- **記号**: ●料理（生まれた）/ ■食材（育てる）/ ◆仕込み（仕込む）。ピンは橙3トーン+輪郭 `#5b4a37`。3群の識別は形が主・色は従
